...
PLS cross validation (5 fold) - HCP-aging
...
################################## Males ######################################
    ...
    pval is (for lv = 0): 0.009900990099009901 (checked)
    pval is (for lv = 1): 0.009900990099009901 (checked)
    pval is (for lv = 2): 0.15841584158415842  (checked)

################################# Females #####################################

    pval is (for lv = 0): 0.009900990099009901 (checked)
    pval is (for lv = 1): 0.009900990099009901 (checked)
    pval is (for lv = 2): 0.2079207920792079   (checked)
...
sex_label = 'Male'   # Do you want to do PLS cross validation for female or male groups?
lv = 0               # You can change this to lv of interest!
...
plt.savefig(path_figures + 'PLS_cross_validation_lv_' + str(lv) + f'_{sex_label}.svg',
        bbox_inches = 'tight',
        dpi = 300,
        transparent = True)
plt.show()
